...
contract MinimalPermit2Test is Test {
    ...
    address constant WSTETH_ADAPTER = 0x7B6D8426280381cfa7724eB0B416A02AdD838611;
    ...
    function disabled_testDirectPermit2() public {
        ...
        permitted[0] = IPermit2.TokenPermissions({token: STETH, amount: 50000000000000000});
        ...
        tokenPermissions[0] = keccak256(abi.encode(_TOKEN_PERMISSIONS_TYPEHASH, permitted[0]));
        ...
        IPermit2.SignatureTransferDetails[] memory transferDetails = new IPermit2.SignatureTransferDetails[](1);
        transferDetails[0] = IPermit2.SignatureTransferDetails({to: WSTETH_ADAPTER, requestedAmount: 50000000000000000});

        console.log("Calling Permit2...");
        IPermit2(PERMIT2).permitBatchTransferFrom(permit, transferDetails, USER, sig);
        console.log("SUCCESS!");
